...
### Прочее: 
* Если здесь что-то не указано - **обязательно** обращаться к PEP8 и/или примерам из документации Python. Если там нет однозначного ответа, первостепенна читаемость кода.
